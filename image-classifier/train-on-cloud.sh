...
REGION="us-central1"
MODEL_NAME="ImageClassifier_256_sigmoid_softmax_categorical_hinge" # change to your model name

CURRENT_DATE=`date +%Y%m%d_%H%M%S`
EPOCHS=100
BATCH_SIZE=16

LAYERS="[{\"class_name\":\"Dense\",\"params\":{\"units\":256,\"activation\":\"sigmoid\"}},{\"class_name\":\"Dropout\",\"params\":{\"rate\":0.5}}]"
